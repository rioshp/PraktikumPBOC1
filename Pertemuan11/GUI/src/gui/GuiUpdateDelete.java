 ...
 */
public class GuiUpdateDelete extends javax.swing.JFrame {
    
    DefaultListModel<String> dlm;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GuiUpdateDelete.class.getName());

    /**
     * Creates new form GuiUpdateDelete
     */
    public GuiUpdateDelete() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GuiUpdateDelete().setVisible(true));
    }
